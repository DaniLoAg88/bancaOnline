...
<div id="divPrincipal" class="col-8">
    <p><h1><b>¡Cambie su PIN!</b></h1></p>
    <p>Por favor, introduzca nuevo PIN:</p>
    <form action="lecturaCambioPin.php" method="post" novalidate>
        <p><input type="password" placeholder="Nuevo pin" name="pin1" id="pin1" class="inputEntrada">
        <p><input type="password" placeholder="Confirme pin" name="pin2" id="pin2" class="inputEntrada">
